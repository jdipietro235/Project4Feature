...
def computeHarrisResponse(image):
    ...
    #derivatives
    imx,imy = gaussDerivatives(image, 3)

    #kernel for blurring
    gauss = matlabStyleGauss2D((3,3),3)
...
def getHarrisPoints(harrisim,min_dist=0, threshold=0.1):
...
def matlabStyleGauss2D(shape=(3,3),sigma=1):
